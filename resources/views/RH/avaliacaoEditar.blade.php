            ...
            <div class="card-body">
                    ...
                    <div class="container table-responsive">
                        ...
                        <table class="table table-sm table-hover table-bordered table-striped">
                            ...
                            <td><textarea type="text" class="form-control-sm" name="obs_tp" >{{ $ls[0]->obs_tp }}</textarea></td>
                            </tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_iac" >{{ $ls[0]->obs_iac }}</textarea></td>
                            </tr>
                            <tr class="text-center"> 
                                <th>REDES SOCIAIS</th>
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_rs" >{{$ls[0]->obs_rs}} </textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_ptj" >{{$ls[0]->obs_ptj}}</textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_rp" >{{$ls[0]->obs_rp}}</textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_if" >{{$ls[0]->obs_if}}</textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_ic" >{{$ls[0]->obs_ic}}</textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_ep" >{{$ls[0]->obs_ep}}</textarea>
                            </td></tr>
                            <tr class="text-center"> 
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_et" >{{$ls[0]->obs_et}}</textarea></td>
                            </tr>
                            <tr class="text-center"> 
                                <th>EXAME MEDICO</th>
                                ...
                                <td><textarea type="text" class="form-control-sm" name="obs_ex" >{{$ls[0]->obs_ex}}</textarea></td>
                            </tr>
