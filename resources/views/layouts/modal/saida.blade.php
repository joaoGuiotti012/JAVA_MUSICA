    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Confirmação de Saida</h5>
        ...
        <div class="modal-body">
          <p>
            Deseja realmente confirmar a saida de <b>{{ $ls->nome }}</b> , cracha: <b> {{$ls->codigo}}</b> ?
          </p>
          </div>
        <div class="modal-footer">
          <form action="{{ route('agendamento.confSaida' , $ls->id ) }}"  method="GET">
            @csrf
