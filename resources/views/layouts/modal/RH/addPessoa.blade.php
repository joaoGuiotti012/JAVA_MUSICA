            ...
            <div class="container">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="endereco" placeholder="Av. Pagotti 123" required>
                    </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-3">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="fone1" id="fone1" required>
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                ...
                                <input type="text" class="form-control" name="cargo_concorrido" required>
                            </div>
                            <div class="form-group col-md-5">
